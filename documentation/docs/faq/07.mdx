...
3. Go inside the folder of a recent version of the SDK (Currently : `MBC-4.3.1`)
4. Download the zip file you find in the folder, such as `Executor MBC-4.3.1.zip`
