...
- Java 21, as constraint of the [eHealth connector](https://www.ehealth.fgov.be/ehealthplatform/fr/service-ehealth-platform-services-connectors) it uses
...
:::tip
    Common reasons if you don't have it :
        ...
        - Your eHealth certificate isn't RSA, as eHealth has ongoing issues with [ECC encryption with some services](https://www.ehealth.fgov.be/ehealthplatform/fr/news/2025-05-19-change-certificates-to-ecc-r20251.1---postponed)
